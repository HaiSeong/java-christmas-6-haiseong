...
class ChristmasDiscountPolicyTest {
    ...
    void applyDiscountBeforeChristmas() {
        ...
        ChristmasDiscountPolicy policy = new ChristmasDiscountPolicy(dateBeforeChristmas);
    ...
    void applyDiscountAfterChristmas() {
        Date dateAfterChristmas = new Date(26); // Assuming 26th is after Christmas
        ChristmasDiscountPolicy policy = new ChristmasDiscountPolicy(dateAfterChristmas);
